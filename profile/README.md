...
- **Documentation** (one site for the whole suite, built by [docs](https://github.com/power-grid-ml/docs)):
  <https://power-grid-ml.readthedocs.io> — concepts, modeling decisions, API reference,
  getting started.
- **Publication**: [pgml-paper](https://github.com/power-grid-ml/pgml-paper) — the manuscript,
  figure scripts and benchmark harnesses of the engine paper. If you use pgml in research,
  please cite it (`CITATION.cff` in the pgml repository).
